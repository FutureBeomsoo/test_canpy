...
def test_periodic_send_with_modifying_data(bus):
    ...
    task = bus.send_periodic(msg, 0.20,modifier_callback = printer(msg))
...
def main():
    ...
    with can.ThreadSafeBus(interface='socketcan', channel='vcan0', bitrate=500000 ,receive_own_messages=True) as bus:
        bus.send(reset_msg)
